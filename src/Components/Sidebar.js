...
<path fillRule="evenodd" clipRule="evenodd" d="M0.5 0.5H12.5V15.5H0.5V0.5ZM27.5 0.5H15.5V9.5H27.5V0.5ZM9.5 12.5V3.5H3.5V12.5H9.5ZM24.5 6.5V3.5H18.5V6.5H24.5ZM24.5 15.5V24.5H18.5V15.5H24.5ZM9.5 24.5V21.5H3.5V24.5H9.5ZM27.5 12.5H15.5V27.5H27.5V12.5ZM0.5 18.5H12.5V27.5H0.5V18.5Z" fill="#828282"/>
</svg>
...
<path fillRule="evenodd" clipRule="evenodd" d="M0.5 6.5L14 0.5L27.5 6.5V15.5C27.5 23.825 21.74 31.61 14 33.5C6.26 31.61 0.5 23.825 0.5 15.5V6.5ZM24.5 16.985H14V3.785L3.5 8.45V17H14V30.395C19.58 28.67 23.705 23.165 24.5 16.985Z" fill="#FE0D0D"/>
</svg>
