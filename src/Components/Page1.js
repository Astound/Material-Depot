...
export  class Page1 extends Component {
  render() {
    ...
    <div className='page1'>
      <button type="button" class="btn custom-button">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus mx-2" viewBox="0 0 16 16">
          ...
          <button type="button" class="btn btn-white" width="100">
  ...
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col" style={{textAlign:'center'}}>No. of members</th>
  ...
  <tbody>
    ...
    <tr>
      <td >o</td>
      <td >External Faculty</td>
      <td><div class="red-boxed">Restricted Access</div>
      </td>
